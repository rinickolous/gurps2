...
class DiceGURPS extends foundry.abstract.DataModel<DiceSchema, foundry.abstract.DataModel.Any> {
	...
	static cleanData(
		source?: Partial<foundry.abstract.DataModel.ConstructorDataFor<DiceGURPS>>,
...
type DiceSchema = {
	sides: fields.NumberField<{ required: true; nullable: false }>
	count: fields.NumberField<{ required: true; nullable: false }>
	modifier: fields.NumberField<{ required: true; nullable: false }>
	multiplier: fields.NumberField<{ required: true; nullable: false }>
}
