import { ActorType, ErrorGURPS, Int, StringBuilder } from "@util"
import { Operator, evalOperators } from "./operators.ts"
import { evalFunctions } from "./function.ts"
import { ActorDataModelClasses } from "@data/actor/types.ts"
...
export function resolverIsCharacter(
	resolver: VariableResolver | null,
): resolver is ActorDataModelClasses[ActorType.Character] {
