	...
	export namespace Roll {
		...
		export function toString(R: Roll): string {
			switch (R) {
				...
				case Roll.CR12:
				case Roll.CR15:
					return i18n.localize(`GURPS.Enum.selfctrl.Roll.${R}`)
				default:
					return i18n.format("GURPS.Enum.selfctrl.Roll.NonStandard", {
						number: R,
					})
			}
		}
	...
	export namespace Adjustment {
		...
		export function description(A: Adjustment, cr: Roll): string {
			switch (true) {
				...
				default:
					return i18n.format(altString(A), {
