...
declare global {
	...
	namespace ExtendedField {
		...
		type ToInputConfigWithOptions<InitializedType> = ToInputBaseConfig & fields.DataField.ToInputConfigWithOptions<InitializedType>

		type ToInputConfigWithChoices<InitializedType, Choices extends fields.DataField.AnyChoices | undefined> = ToInputBaseConfig & fields.DataField.ToInputConfigWithChoices<InitializedType, Choices>
	}
